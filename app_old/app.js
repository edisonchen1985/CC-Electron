...
const helpTemplate = [
    {
        ...
        click: () => electron.remote.shell.openExternal('https://rocket.chat/docs')
    },
    {
        type: 'separator'
    },
    {
        ...
        click: () => electron.remote.shell.openExternal('https://github.com/RocketChat/Rocket.Chat/issues')
    },
    {
    ...
    },
    {
        ...
        click: () => electron.remote.shell.openExternal('https://rocket.chat')
    }
];
